...
//  page += _customHeadElement;
  ...
  page += F("</dd>");
  page += F("<dt>Last Station SSID</dt><dd>");
  page += STAssID;
  page += F("</dd>");
  if(WiFi.isConnected()) {
    page += F("<dt>Station Connected To SSID</dt><dd>");
    page += WiFi.SSID();
    page += F("</dd>");
    page += F("<dt>Station Connected To password</dt><dd>");
    page += WiFi.psk();
    page += F("</dd>");
    page += F("<dt>Station Connected To BSSID</dt><dd>");
    page += WiFi.BSSIDstr();
    page += F("</dd>");
    page += F("<dt>Station Connected To Received Signal Strenght Indication</dt><dd>");
    page += WiFi.RSSI();
    page += F("</dd>");
    page += F("<dt>Station IP</dt><dd>");
    page += WiFi.localIP().toString();
    page += F("</dd>");
    page += F("<dt>Station Subnet Mask</dt><dd>");
    page += WiFi.subnetMask().toString();
    page += F("</dd>");
    page += F("<dt>Station Gateway IP</dt><dd>");
    page += WiFi.gatewayIP().toString();
    page += F("</dd>");
    page += F("<dt>Station DNS IP 0</dt><dd>");
    page += WiFi.dnsIP().toString();
    page += F("</dd>");
    page += F("<dt>Station DNS IP 1</dt><dd>");
